...
import IndonesiaFlag from 'country-flag-icons/react/3x2/ID';
...
const Header = ({ title, toggleSidebar, user }) => {
  ...
  const currentLang = i18n.language === 'id' ? <IndonesiaFlag style={{ width: 24, height: 16, objectFit: 'cover', borderRadius: 2 }} /> : <USFlag style={{ width: 24, height: 16, objectFit: 'cover', borderRadius: 2 }} />;
    ...
    <div className="flex justify-between items-start md:items-center">
      ...
      <div className="flex items-center gap-3">
        ...
        >
          ...
          >
            <IndonesiaFlag style={{ width: 20, height: 14, marginRight: 8, objectFit: 'cover', borderRadius: 1 }} />
            Bahasa Indonesia
          </MenuItem>
          <MenuItem
          ...
          >
            <USFlag style={{ width: 20, height: 14, marginRight: 8, objectFit: 'cover', borderRadius: 1 }} />
            English
          </MenuItem>
        </Menu>
